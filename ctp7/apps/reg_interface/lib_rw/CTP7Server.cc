...
unsigned int CTP7Server::processTCPMessage(void *iData, 
  ...
  if(strncmp(function, "getAddress", 10) == 0) {
    if(argc == 3){
      unsigned int value = getAddress((BufferType) argv[0], argv[1], argv[2]);
  ...
  if(strncmp(function, "getRegister", 10) == 0) {
    if(argc == 1) {
      unsigned int value = getRegister(argv[0]);
      sprintf(oMessage, "%X", value);
    }
    else
      strcpy(oMessage, "ERROR_WRONG_NARGS");
  ...
  if(strncmp(function, "setRegister", 10) == 0) {
    if(argc >1 ) {
  ...
  if(strncmp(function, "setAddress", 10) == 0) {
    if(argc == 4) {
      if(setAddress((BufferType) argv[0], argv[1], argv[2], argv[3])) {
	strcpy(oMessage, "SUCCESS");
      }
      else
	strcpy(oMessage, "FAILED To Set Address");
    }
  }

  if(strncmp(function, "dumpContiguousBuffer", 10) == 0) {
    if(argc == 4) {
  ...
  if(strncmp(function, "setConstantPattern", 10) == 0) {
    if(argc == 3) {
  ...
  if(strncmp(function, "setIncreasingPattern", 10) == 0) {
    if(argc == 4) {
  ...
  if(strncmp(function, "setDecreasingPattern", 10) == 0) {
    if(argc == 4) {
  ...
  if(strncmp(function, "setRandomPattern", 10) == 0) {
    if(argc == 3) {
  ...
  if(strncmp(function, "setPattern", 10) == 0) {
    if(argc > 1) {
