...
#
#   MakeMaker ARGV: (q[PREFIX=/mnt/persistent/texas/apps/git/final], q[INSTALL_BASE=])
#
...
#     MAKEFILE => q[perl.mak]
#     NAME => q[Git]
#     PM => { Git/SVN/Editor.pm=>q[$(INST_LIBDIR)/Git/SVN/Editor.pm], Git/SVN/Migration.pm=>q[$(INST_LIBDIR)/Git/SVN/Migration.pm], Git/SVN/Log.pm=>q[$(INST_LIBDIR)/Git/SVN/Log.pm], Git/SVN.pm=>q[$(INST_LIBDIR)/Git/SVN.pm], Git/SVN/Memoize/YAML.pm=>q[$(INST_LIBDIR)/Git/SVN/Memoize/YAML.pm], Git/SVN/Ra.pm=>q[$(INST_LIBDIR)/Git/SVN/Ra.pm], Git/I18N.pm=>q[$(INST_LIBDIR)/Git/I18N.pm], Git/SVN/Prompt.pm=>q[$(INST_LIBDIR)/Git/SVN/Prompt.pm], Git/SVN/GlobSpec.pm=>q[$(INST_LIBDIR)/Git/SVN/GlobSpec.pm], Git/SVN/Fetcher.pm=>q[$(INST_LIBDIR)/Git/SVN/Fetcher.pm], Git/IndexInfo.pm=>q[$(INST_LIBDIR)/Git/IndexInfo.pm], Git/SVN/Utils.pm=>q[$(INST_LIBDIR)/Git/SVN/Utils.pm], Git.pm=>q[$(INST_LIBDIR)/Git.pm] }
#     PM_FILTER => q[$(PERL) -pe "s<\Q++LOCALEDIR++\E></mnt/persistent/texas/apps/git/final/share/locale>"]
#     PREREQ_PM => {  }
...
INSTALL_BASE = 
DESTDIR = 
PREFIX = /mnt/persistent/texas/apps/git/final
PERLPREFIX = $(PREFIX)
SITEPREFIX = $(PREFIX)
VENDORPREFIX = $(PREFIX)
...
MACROEND = 
USEMAKEFILE = -f
PM_FILTER = $(PERL) -pe "s<\Q++LOCALEDIR++\E></mnt/persistent/texas/apps/git/final/share/locale>"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Git' >> META_new.yml
...
disttest : distdir
	cd $(DISTVNAME) && $(ABSPERLRUN) Makefile.PL "PREFIX=/mnt/persistent/texas/apps/git/final" "INSTALL_BASE="
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "PREFIX=/mnt/persistent/texas/apps/git/final" "INSTALL_BASE="
